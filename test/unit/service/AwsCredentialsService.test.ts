...
describe("AwsCredentialsService", () => {
    ...
    describe("saveAwsCredentials", () => {
        ...
        test("should save aws credentials", async () => {
            ...
            const output = await awsCredentialsService.saveAwsCredentials(
                saveAwsCredentialsDtoInput,
            )
    ...
    describe("findAwsCredentials", () => {
        ...
        test("should find aws credentials", async () => {
            const awsCredentialsEntity = new AwsCredentialsEntity(
                accessKeyId,
                secretAccessKey,
            )
            jest.spyOn(
                awsCredentialsRepository,
                "findAwsCredentials",
            ).mockResolvedValue(awsCredentialsEntity)

            const output = await awsCredentialsService.findAwsCredentials(
                findAwsCredentialsDtoInput,
            )
            ...
            expect(output).toEqual(
                new FindAwsCredentialsDtoOutput(accessKeyId, secretAccessKey),
            )
        })
    })
    ...
    describe("awsCredentialsExists", () => {
        ...
        test("should return aws credentials does not exist", async () => {
            jest.spyOn(
                awsCredentialsRepository,
                "findAwsCredentials",
            ).mockRejectedValue(new AwsCredentialsDoesNotExistException())

            const output = await awsCredentialsService.awsCredentialsExists(
                awsCredentialsExistsDtoInput,
            )
    ...
    describe("updateAwsCredentials", () => {
        ...
        test("should update aws credentials", async () => {
            ...
            const output = await awsCredentialsService.updateAwsCredentials(
                updateAwsCredentialsDtoInput,
            )
    ...
    describe("deleteAwsCredentials", () => {
        ...
        test("should delete aws credentials", async () => {
            ...
            const output = await awsCredentialsService.deleteAwsCredentials(
                deleteAwsCredentialsDtoInput,
            )
