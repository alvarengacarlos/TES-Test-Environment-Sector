...
describe("SourceCodeRepositoryImpl", () => {
    ...
    const sourceCodeRepository = new SourceCodeRepositoryImpl(getS3ClientWithCredentialsMock)
    ...
    describe("uploadSourceCode", () => {
        ...
        test("should try verify if source code storage exists and throw S3Exception", async () => {
            ...
            await expect(sourceCodeRepository.uploadSourceCode(uploadSourceCodeInput)).rejects.toThrow(S3Exception)
        })
        ...
        test("should create a source code storage and upload source code", async () => {
            ...
            await expect(sourceCodeRepository.uploadSourceCode(uploadSourceCodeInput)).resolves.not.toThrow(S3Exception)
        })
    ...
    describe("findSourceCodes", () => {
        ...
        test("should throw S3Exception", async () => {
            ...
            await expect(sourceCodeRepository.findSourceCodes(findSourceCodesInput)).rejects.toThrow(S3Exception)
        })
        ...
        test("should find source codes", async () => {
            ...
            await expect(sourceCodeRepository.findSourceCodes(findSourceCodesInput)).resolves.not.toThrow(S3Exception)
        })
    })
    ...
    describe("deleteSourceCode", () => {
        ...
        test("should throw S3Exception", async () => {
            ...
            await expect(sourceCodeRepository.deleteSourceCode(deleteSourceCodeInput)).rejects.toThrow(S3Exception)
        })

        test("should delete source code", async () => {
            s3ClientMocked.on(DeleteObjectCommand).resolves({})

            await expect(sourceCodeRepository.deleteSourceCode(deleteSourceCodeInput)).resolves.not.toThrow(S3Exception)
        })
    })
})