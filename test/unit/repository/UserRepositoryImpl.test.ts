...
describe("UserRepositoryImpl", () => {
    ...
    describe("saveUser", () => {
        ...
        test("should throw EmailExistsException", async () => {
            cognitoClientMocked.on(SignUpCommand).rejects(
            ...
            await expect(
                userRepository.saveUser(saveUserInput),
    ...
    describe("updateUserEmailToVerified", () => {
        ...
        test("should throw ExpiredConfirmationCodeException", async () => {
            cognitoClientMocked.on(ConfirmSignUpCommand).rejects(
            ...
            await expect(
                userRepository.updateUserEmailToVerified(
                    updateUserEmailToVerifiedInput,
                ),
            ).rejects.toThrow(ExpiredConfirmationCodeException)
        })
        ...
        test("should throw InvalidConfirmationCodeException", async () => {
            ...
            ).rejects.toThrow(InvalidConfirmationCodeException)
        ...
        test("should update a user email to verified", async () => {
            ...
            const output = await userRepository.updateUserEmailToVerified(
                updateUserEmailToVerifiedInput,
            )
    ...
    describe("authenticateUser", () => {
        ...
        test("should throw IncorrectEmailOrPasswordException", async () => {
            cognitoClientMocked.on(AdminInitiateAuthCommand).rejects(
            ...
            await expect(
                userRepository.authenticateUser(authenticateUserInput),
        ...
        test("should authenticate a user", async () => {
            ...
            const output = await userRepository.authenticateUser(
