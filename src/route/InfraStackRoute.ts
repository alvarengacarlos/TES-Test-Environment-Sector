...
infraStackRouter.post(
    "/infra-stacks",
    setTokenInformations,
    infraStackValidator.createInfraStackValidator,
...
infraStackRouter.delete(
    "/infra-stacks/:stackName",
    setTokenInformations,
    infraStackValidator.deleteInfraStackNameValidator,
    async (request: Request, response: Response, next: NextFunction) => {
        try {
