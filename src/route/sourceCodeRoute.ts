...
sourceCodeRoute.post("/source-codes", setTokenInformations, sourceCodeValidator.uploadSourceCodeValidator, async (request: Request, response: Response, next: NextFunction) => {
    try {
...
sourceCodeRoute.get("/source-codes", setTokenInformations, async (request: Request, response: Response, next: NextFunction) => {
    try {
...
sourceCodeRoute.delete("/source-codes/:sourceCodePath", setTokenInformations, sourceCodeValidator.deleteSourceCodeValidator, async (request: Request, response: Response, next: NextFunction) => {
    try {
