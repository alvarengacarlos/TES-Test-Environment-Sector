...
awsCredentialsRouter.post(
    "/aws-credentials",
    setTokenInformations,
    awsCredentialsValidator.saveAwsCredentialsValidator,
...
awsCredentialsRouter.put(
    "/aws-credentials",
    setTokenInformations,
    awsCredentialsValidator.updateAwsCredentialsValidator,
    async (request: Request, response: Response, next: NextFunction) => {
        try {
