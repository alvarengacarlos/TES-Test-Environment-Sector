...
export class InfraStackValidator {
    createInfraStackValidator(request: Request, response: Response, next: NextFunction) {
    ...
    deleteInfraStackNameValidator(request: Request, response: Response, next: NextFunction) {
        const schema = Joi.object({
